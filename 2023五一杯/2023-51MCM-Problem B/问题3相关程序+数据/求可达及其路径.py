...
data = pd.read_excel("C:\\Users\\Administrator\\Desktop\\vs工作界面\\附件2.xlsx").values
...
temp=pd.DataFrame(np.c_["1",lines,all_pre1,p2],columns=["起点","终点","28号是否开通","29号是否开通","28号预测值","29号预测值"])
temp.to_excel("C:\\Users\\Administrator\\Desktop\\vs工作界面\\第三问结果.xlsx")