...
# 导入附件1
data = pd.read_excel(r"C:\Users\MATH_MGD\Desktop\2023-51MCM-Problem B\附件1(Attachment 1)2023-51MCM-Problem B.xlsx").values
...
#pd.DataFrame(datat,index = city,columns=col).to_excel(r"C:\Users\MATH_MGD\Desktop\城市指标数据.xlsx")
